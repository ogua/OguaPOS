...
class SaleReturnResource extends Resource
{
    ...
    protected static ?string $slug = 'sales-return';
            ...
            ->schema([
                    Forms\Components\Section::make('')
                        ...
                        Forms\Components\Select::make('sale_id')
                            ...
                            ->required()
                            ->options(Sales::latest()->pluck('reference_number','id'))
                            ->preload()
                            ->searchable()
                            ->live()
                            ->afterStateUpdated(function ($state,$set,$get){
                                ...
                                $sale = Sales::findorfail($state);
                                $set("cash_register_id",$sale->cash_register_id);
                                $set("reference_no",$sale->reference_number);
                                $set("account_id",$sale->payment?->account_id);
                                $set("total_qty",$sale->total_qty);
                                $set("total_discount",$sale->total_discount);
                                //$set("total_tax",$sale->order_tax);
                                $set("item",$sale->item);

                                foreach ($sale->saleitem as $key => $item) {
                        ...
                        ->deleteAction(
                            ...
                            ->schema([
                                ...
                                Forms\Components\Hidden::make('saleitem_id')
                                ->dehydrated(false),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                ->label('Warehouse')
                    ->searchable(),
                Tables\Columns\TextColumn::make('sale.biller.name')
                ->label('Biller')
                ->searchable(),
            ...
            ->actions([
                ActionGroup::make([
                    ...
                    ->modalContent(fn (SaleReturn $record): View => view(
                        'filament.resources/sales-resource.pages.sales-return',
                        ['record' => $record],
                    )),
                    ...
                    ->action(function($data,SaleReturn $record,Request $request){
                        ...
                        ->schema([
                            ...
                            Actions::make([
                                ...
                                ->before(function($record){
                                    ...
                                    $payment = SaleReturn::where('id',$record->purchase_return_id)->first();
    ...
    public static function getPages(): array
    {
        return [
           ...
           // 'view-sale' => Pages\ViewSaleReturns::route('/{record}'),
        ];
    }
}
