...
namespace App\Filament\Cashier\Resources\InvoiceResource\Pages;

use App\Filament\Cashier\Resources\InvoiceResource;
                            ...
                            ->options([
                                ...
                                ->afterStateUpdated(function (Forms\Set $set,Forms\Get $get, ?string $state) {
                                    ...
                                    if ($product_type == "Single") {
                                        ...
                                        $px = $get("pricetype") == "DEFAULT" ?  $product_variant_data->selling_price : $product_variant_data->wholesale_price;
                                ...
                                ->deleteAction(
                                    ...
                                    ->hintAction(
                                        ...
                                        ->hintAction(
                                            ...
                                            ->form([
                                                ...
                                                Forms\Components\Placeholder::make('cgrand_total')
                                                ->content(function ($get,$set){
                                    ...
                                    Step::make('Terms')
                                    ->description('Quotation note or terms')
                                    ->schema([
