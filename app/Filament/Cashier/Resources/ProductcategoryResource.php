...
use App\Filament\Cashier\Resources\ProductcategoryResource\Pages;
use App\Filament\CashierResources\ProductcategoryResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // ->state(fn ($record) => ($record->product->inventory->sum('qty') ?? 0)."(".$record->product->unit->code.")s"),
